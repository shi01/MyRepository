...
+"<td style='text-align: center;'><a style='color: blue;' href='#' onclick='"+editOrView+"("+data[i].id+")'>超链接</a></td>"
+"<td style='text-align: center;'>"+filterNull(data[i].roleId)+"</td>"
+"<td style='text-align: center;'>"+filterNull(data[i].menuId)+"</td>"
+"<td style='text-align: center;'>"+filterNull(data[i].power)+"</td>"
...
function delDate(id){
	$.ajax({
		type : 'post',
		url : domain + "/admin/permission/delete",
		data : {
			id : id,
			token : token
		},
