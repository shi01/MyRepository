...
+"<td style='text-align: center;'><a style='color: blue;' href='#' onclick='"+editOrView+"("+data[i].id+")'>"+filterNull(data[i].name)+"</a></td>"
+"<td style='text-align: center;'>"+filterNull(data[i].username)+"</td>"
+"<td style='text-align: center;'>"+trans('sys_role',filterNull(data[i].roleId))+"</td>"
