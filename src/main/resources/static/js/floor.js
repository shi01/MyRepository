...
+"<td style='text-align: center;'><a style='color: blue;' href='#' onclick='"+editOrView+"("+data[i].id+")'>"+filterNull(data[i].floorName)+"</a></td>"
